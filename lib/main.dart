...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          ...
          // created by the App.build method, and use it to set our
          // appbar title.
        ...
        body: Center(
          ...
          child: Column(
            ...
            // "Toggle Debug Paint" action in the IDE, or press "p" in the
            // console), to see the wireframe for each widget.
